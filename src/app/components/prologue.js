  ...
  return (
      ...
      <section  className="contact-section pt-150 pb-140 bg_img" data-background="/assets/img/bg/contact-bg.png"> 
                             ...
                             <div className="xb-content-wrap">
                                 ...
                                 {/* <div className="xb-contact-conent wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="600ms">
                                     ...
                                     <div className="shape shape--2"><img src="/assets/img/shape/contact-shape02.png" alt="shape" /></div>
                                      ...
                                      <div className="slide-in-left" style={{ animationDelay: "0.05s" }}>
              {/* <h2 className="section-title" >Prologue</h2> */}
              {/* <h4 className="font-display text-foreground mb-4">
              ...
              <blockquote className="text-muted-foreground mb-8 border-l-4 border-primary pl-6 italic">
                ...
                <br />
                <p>
                  Our mission is to empower organizations with intelligent, secure, and salable IT solutions that drive growth and lasting impact.
                  With expertise in AI & Generative Technologies, Cybersecurity, Cloud & Data Services, and Application Development, we support industries with agility and confidence.
                </p>
                <br />
                <p>
